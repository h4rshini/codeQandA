...
ARG TARGET_URL=https://github.com/h4rshini/Signal-stockwatchlist
# One line shown under the page title to tell visitors what the repo is.
ENV CODEQA_REPO_DESCRIPTION="a stock watchlist app"
...
RUN python -m codeqa.indexer /home/user/Signal-stockwatchlist --url "$TARGET_URL"
